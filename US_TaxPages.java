...
import org.openqa.selenium.support.ui.WebDriverWait;
...

	{
		...
		/*public void filter()
		{
			...
			//scroll down
			driver.findElement(By.id("input-date-start")).sendKeys("2019-06-26");
			driver.findElement(By.id("input-date-end")).sendKeys("2019-07-28");
			driver.findElement(By.cssSelector("#form-review > div.form-group.required.has-error > div > ul > li")).click();
		...
		public void TaxstatusFilter() {
			 ...
			 driver.findElement(datestart).click();
				...
				//order id
				String order_status_to_search="2019-07-08";
				
				 driver.findElement(datestart).sendKeys(order_status_to_search);
				 driver.findElement(By.xpath("//*[@id=\"button-filter\"]")).click();
				try { 
				    WebElement t= driver.findElement(By.xpath("//*[@id=\"input-date-start\"]"));// xpath od the order id listed below after clicking filter
		...
		public void TaxstatusFilter2() {
			 ...
			 driver.findElement(dateend).click();
				////*[@id="content"]/div[2]/div[3]/div[2]/div[1]/div/div[2]/div[1]/label
				//order id
				String order_status_to_search="2020-07-08";
				
				 driver.findElement(dateend).sendKeys(order_status_to_search);
				 driver.findElement(By.xpath("//*[@id=\"button-filter\"]")).click();
				try { 
				    WebElement t= driver.findElement(By.xpath("//*[@id=\"input-date-end\"]"));// xpath od the order id listed below after clicking filter
				    String order_statusListed=t.getText();//getting the value of the order id listed below
				    if(order_status_to_search.equals(order_statusListed))//checking wether the id wch we entered in order id matches to the order id listed below
				      {
					    System.out.println("Found"); 
		...
		public void TaxstatusFilter3() {
			 ...
			 driver.findElement(groupby).click();
				////*[@id="content"]/div[2]/div[3]/div[2]/div[1]/div/div[2]/div[1]/label
				//order id
				String order_status_to_search="Weeks";
				
				 driver.findElement(groupby).sendKeys(order_status_to_search);
				 driver.findElement(By.xpath("//*[@id=\"button-filter\"]")).click();
				/*try { 
